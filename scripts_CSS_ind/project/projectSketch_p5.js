...
function preload(){
	...
	spriteSheet = loadImage("scripts_CSS_ind/project/assets/sprites/sprites1.png");
	mntBG0 = loadImage("scripts_CSS_ind/project/assets/sprites/BG0.png", asset=> {onImageLoad(asset, levelData[0].levelBackgroundImages[0])});
	mntBG1 = loadImage("scripts_CSS_ind/project/assets/sprites/BG1.png", asset=> {onImageLoad(asset, levelData[0].levelBackgroundImages[1])});
	mntBG2 = loadImage("scripts_CSS_ind/project/assets/sprites/BG2.png", asset=> {onImageLoad(asset, levelData[0].levelBackgroundImages[2])});
}
